...
public class EditAdServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Ad ad = new Ad();
        ad.setId(Integer.parseInt(request.getParameter("adid")));
        ad.setTitle(request.getParameter("title"));
        ad.setUser_id(Integer.parseInt(request.getParameter("user_id")));
        ...
        ad.setActive(Integer.parseInt(request.getParameter("active")));
        ad.setCat_id(Integer.parseInt(request.getParameter("cat_id")));
